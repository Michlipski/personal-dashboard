  ...
  return (
    <ThemedView type="backgroundElement" style={styles.card}>
      ...
      <View style={styles.barControlRow}>
        ...
        {/* Web Rainbow Spectrum Bar: Underlying Gradient with Opacity Filter Overtop */}
        <div style={styles.webTrack}>
          <div
            style={{
              position: 'absolute',
              top: 0,
...
const styles = StyleSheet.create({
  ...
  legendRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingHorizontal: 44, // Inset aligned with the bar between the buttons
  },
  legendText: {
    fontSize: 10,
  },
